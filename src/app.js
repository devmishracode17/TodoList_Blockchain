App = {
    ...
    load: async () => {
        ...
        await App.loadWeb3(); // load web3 library to connect ot the blockchain
    ...
    // we use metamask to connect our browser to  blockchain
    // web3Js is used to connect our client side application to blockchain. 
    // use web3js library to talk to eth blockchain, and W/R data to blockchain

    //connect to blockchain with this function
    loadWeb3: async () => {
   ...
   loadContract: async () => {
        ...
        // truffle contract is a js representation of the smart contract
    ...
    renderTasks: async () => {
        ...
        // render each of the tasks with a new task template 
